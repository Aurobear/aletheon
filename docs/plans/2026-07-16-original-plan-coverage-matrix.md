...
| Delete `CoreSystems` and split private lifecycle bootstrap | `architecture-coupling-optimization-plan.md:1055-1056`, `:1062-1063` | X02 | Executable plan: `2026-07-15-x02-private-composition-root.md`; current remaining references enumerated at plan lines 17-25 | planned |
