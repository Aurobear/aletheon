...
- [`2026-08-16-architecture-coupling-closeout.md`](./2026-08-16-architecture-coupling-closeout.md) — **耦合收敛（P0 账本 / P1 Turn+Application / P2 反向边 / P3 验收证伪）**
...
1. 先读 closeout 计划的前置条件 + P0.1，不要从旧 Kernel V2 / Luna / 08-14 文件重新开任务。
2. 当前工作区和生产调用链是代码事实源；locator 漂移时先更新清单，不要为旧文本增加兼容层。
3. 一次只做一个编号步骤，验证后停下。
4. 本包完成定义见 closeout 各阶段“完成标准”。安装态 `sudo deploy` 不在本包。
