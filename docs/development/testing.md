...
| End-to-end | Full user flows | interact + test | 5 critical scenarios | Not acceptable |
...
|----------|-------|-------------|
| Basic conversation | Start aletheond -> interact sends message -> receive response | Response is non-empty, no errors |
