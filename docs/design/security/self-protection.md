...
|-----------|--------|---------------|-------|
| InputSanitizer | ✅ Implemented | `crates/agent-core/src/security/self_protection/input_sanitizer.rs` | Prompt injection detection + sanitization |
| ResourceGovernor | ✅ Implemented | `crates/agent-core/src/security/self_protection/resource_governor.rs` | Multi-resource limits + throttling |
| EmergencyKillswitch | ✅ Implemented | `crates/agent-core/src/security/self_protection/emergency_killswitch.rs` | Multi-trigger emergency stop |
| IntegrityMonitor | ✅ Implemented | `crates/agent-core/src/security/self_protection/integrity_monitor.rs` | FNV-1a hash checking, baseline tracking, killswitch integration |
...
struct IntegrityMonitor {
    ...
    binary_hash: Hash,                       // agentd 二进制的已知 hash
    /// 定期完整性检查（默认每 5 分钟）
...
| 检查项 | 方法 | 检查频率 |
|--------|------|----------|
| agentd 二进制 | mmap + SHA256 | 启动时 + 每 5min |
...
|-----------|--------|-------|
| InputSanitizer | ✅ Implemented | `crates/agent-core/src/security/self_protection/input_sanitizer.rs` |
| ResourceGovernor | ✅ Implemented | `crates/agent-core/src/security/self_protection/resource_governor.rs` |
| EmergencyKillswitch | ✅ Implemented | `crates/agent-core/src/security/self_protection/emergency_killswitch.rs` |
| IntegrityMonitor | ✅ Implemented | `crates/agent-core/src/security/self_protection/integrity_monitor.rs` — FNV-1a, baseline, killswitch integration |
