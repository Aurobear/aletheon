...
WritableRoot 作为 PolicyEngine 的子组件，在工具调用链中介入路径权限检查。完整调用链见 [security-model.md](security-model.md) §4.9。
...
*源文档: [安全模型](security-model.md) §3.2, §3.4, §4.4-4.9*
...
**Code Locations:**
- `argos/crates/agent-core/src/security/sandbox/writable_root.rs` — WritableRoot (planned, not yet implemented)
