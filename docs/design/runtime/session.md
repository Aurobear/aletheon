...
> Migrated from `docs/design/core/session-lifecycle.md` (session persistence and crash recovery sections only) — code paths updated to aletheon-* crate structure
