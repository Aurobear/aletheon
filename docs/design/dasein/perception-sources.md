> Migrated from docs/design/perception/system-management.md — code paths updated to match actual crate names (fabric, cognit, corpus, dasein, mnemosyne, metacog, interact, executive)

# 系统服务管理 (System Service Management)

> Agent 不只是"运行在 OS 上"的 daemon，而是"管理 OS"的系统管理者。

**关联模块:** [感知层](../dasein/perception.md), [安全模型](../corpus/security.md), [认知引擎](../cognit/cognitive-engine.md)
**最后更新:** 2026-06-06
