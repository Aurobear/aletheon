...
**Crate:** `executive`
**Code location:** `executive/src/impl/session/observability/`
...
|-----------|--------|---------------|-------|
| EventJournal | Implemented | `executive/src/impl/session/journal.rs` | JSONL append-only log |
| Durable/Ephemeral split | Planned | — | Event classification designed, not started |
| Fragment Accumulator | Planned | `executive/src/impl/session/observability/fragment.rs` | Streaming delta accumulation designed |
| Debug CLI (JSON-RPC) | Planned | — | 8 RPC methods designed |
| Prometheus metrics | Planned | `executive/src/impl/session/observability/metrics.rs` | prometheus-client integration designed |
| ToolTracker | Planned | `executive/src/impl/session/observability/tool_tracker.rs` | Per-callID tool call lifecycle state machine |
| ReasoningLogger | Planned | `executive/src/impl/session/observability/reasoning_logger.rs` | Structured reasoning log |
| EventPublisher | Planned | `executive/src/impl/session/observability/publisher.rs` | Event fan-out to journal, subscribers, metrics |
...
Code location: `executive/src/impl/session/observability/fragment.rs`
...
Code location: `executive/src/impl/session/observability/tool_tracker.rs`
...
Code location: `executive/src/impl/session/observability/reasoning_logger.rs`
...
Code location: `executive/src/impl/session/observability/metrics.rs`
...
Code location: `executive/src/impl/session/observability/publisher.rs`
...
interact debug status

# Stream reasoning log
interact debug follow-reasoning [--filter "Thinking|ToolCall*"]

# View last N reasoning steps
interact debug recent-steps [--n 20]

# View memory usage
interact debug memory

# View Hook registration state
interact debug hooks

# View Prometheus metrics
interact debug metrics

# Replay specified session history
interact debug replay --session-id <id> [--from-seq 0]

# Subscribe to real-time event stream
interact debug subscribe [--filter "ToolCall*"] [--ephemeral]
```
...
**Code locations:**
- `executive/src/impl/session/observability/fragment.rs` — FragmentAccumulator
- `executive/src/impl/session/observability/metrics.rs` — MetricsExporter
- `executive/src/impl/session/observability/publisher.rs` — EventPublisher
- `executive/src/impl/session/observability/reasoning_logger.rs` — ReasoningLogger
- `executive/src/impl/session/observability/tool_tracker.rs` — ToolTracker
