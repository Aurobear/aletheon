...
**Crate:** `executive`
**Code location:** `executive/src/impl/automation/`
...
|-----------|--------|---------------|-------|
| AutomationScheduler | Implemented | `executive/src/impl/automation/mod.rs` | Top-level scheduler with CRUD, cron/webhook triggers |
| CronParser | Implemented | `executive/src/impl/automation/cron.rs` | Cron expression parsing and matching |
| DeliveryManager | Implemented | `executive/src/impl/automation/delivery.rs` | Multi-channel delivery (Telegram, Discord, Slack, Email, Webhook, Local, Stdout) |
| ScriptRunner | Implemented | `executive/src/impl/automation/script.rs` | Script pre-processing execution |
| WebhookEvent | Implemented | `executive/src/impl/automation/webhook.rs` | Webhook event matching and HMAC verification |
...
Code location: `executive/src/impl/automation/cron.rs`
...
Code location: `executive/src/impl/automation/webhook.rs`
...
Code location: `executive/src/impl/automation/mod.rs`
...
Code location: `executive/src/impl/automation/delivery.rs`
...
|-----------|---------------|-----------|
| AutomationScheduler | `executive/src/impl/automation/mod.rs` | `AutomationScheduler`, `Automation`, `AutomationTrigger`, `DeliveryTarget`, `AutomationResult` |
| CronParser | `executive/src/impl/automation/cron.rs` | `CronParser`, `CronSchedule` |
| DeliveryManager | `executive/src/impl/automation/delivery.rs` | `DeliveryManager` |
| ScriptRunner | `executive/src/impl/automation/script.rs` | `ScriptRunner` |
| WebhookEvent | `executive/src/impl/automation/webhook.rs` | `WebhookEvent`, `matches_event_type()` |
