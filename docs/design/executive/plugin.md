...
**Crate:** `executive`
**Code location:** `crates/executive/src/adapters/plugin/`
...
|-----------|--------|---------------|-------|
| PluginManifest | Implemented | `crates/executive/src/adapters/plugin/manifest.rs` | TOML-based plugin manifest with validation |
| PluginLoader | Implemented | `crates/executive/src/adapters/plugin/loader.rs` | Discovery and dependency resolution |
| PluginManager | Implemented | `crates/executive/src/adapters/plugin/manager.rs` | Lifecycle management, tool creation |
| PluginRuntime | Implemented | `crates/executive/src/adapters/plugin/runtime.rs` | Command-based execution (native/WASM/agent planned) |
...
Code location: `crates/executive/src/adapters/plugin/manifest.rs`
...
Code location: `crates/executive/src/adapters/plugin/loader.rs`
...
Code location: `crates/executive/src/adapters/plugin/manager.rs`
...
Code location: `crates/executive/src/adapters/plugin/runtime.rs`
...
|-----------|---------------|-----------|
| PluginManifest | `crates/executive/src/adapters/plugin/manifest.rs` | `PluginManifest`, `PluginToolDef`, `PluginHookDef`, `PluginDependency`, `PluginPermissions` |
| PluginLoader | `crates/executive/src/adapters/plugin/loader.rs` | `PluginLoader` |
| PluginManager | `crates/executive/src/adapters/plugin/manager.rs` | `PluginManager`, `PluginState`, `ManagedPlugin`, `PluginTool` |
| PluginRuntime | `crates/executive/src/adapters/plugin/runtime.rs` | `PluginRuntime` (Command variant) |
