...
///
/// Could be a user request, a CognitCore plan, or a MetaRuntime mutation.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct Intent {
...
///
/// Generated by CognitCore during reasoning, this carries the agent's
...
///
/// Initial four variants. Grows based on experience — CognitCore
...
/// Consumed by CognitCore to enrich future awareness generation.
#[derive(Debug, Clone, Serialize, Deserialize)]
