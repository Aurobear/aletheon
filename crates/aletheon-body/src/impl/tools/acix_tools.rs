...
fn format_element(elem: &crate::r#impl::driver::types::Element, depth: usize) -> String {
        ...
        match self.aci.smart_observe() {
            Ok(observation) => {
                let text = match observation {
                    crate::r#impl::driver::types::Observation::AccessibilityTree(tree) => {
                        format!(
                            "[AT-SPI2] app: {}\n{}",
                            tree.app_name,
                    ...
                    crate::r#impl::driver::types::Observation::OcrFallback(ocr) => {
...
pub fn register_acix_tools(registry: &mut super::ToolRegistry) {
