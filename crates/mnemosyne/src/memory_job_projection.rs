...
use runtime::read_model::{EventProjection, ProjectionDescriptor, ProjectionError};
use runtime::{EventPayload, EventVisibility, SpineEvent};
...
impl EventProjection for MemoryJobProjection {
    ...
    fn apply(&self, state: &mut Self::State, event: &SpineEvent) -> Result<(), ProjectionError> {
        ...
        if event.schema.0 == ::contracts::SchemaId::EVENT_MEMORY_CANDIDATE_V1 {
