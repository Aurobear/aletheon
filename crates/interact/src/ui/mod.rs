...
use base::ui_event::{AwarenessLevel, CollaborationMode, PlanUpdate, SubAgentHandle, SubAgentStatus, EvolutionStage};
...
fn format_models(result: &serde_json::Value) -> String {
    let empty = vec![];
