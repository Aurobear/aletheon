...
use base::tool::{Tool as ToolTrait, ToolResult};
use base::{ContentBlock, Message, Role};
use cognit::r#impl::llm::{StopReason, StreamChunk, Usage};
...
use dasein::r#impl::security::runner::ToolError;
...
impl Engine {
    ...
    pub async fn run_turn_streaming(&mut self, user_input: &str) -> Result<String> {
        ...
        if self.agent_registry.is_some() {
            ...
            tool_defs.push(base::ToolDefinition {
