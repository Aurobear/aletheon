...
//! cognitive harnesses (e.g. `cognit::ReActLoop`). Runtime owns the context-working-set contract so cognitive and memory
//! implementations share one provider-neutral authority without depending on
//! each other or on the host runtime.
//!
...
use crate::{ContentBlock, LlmProvider, Message, Role};
