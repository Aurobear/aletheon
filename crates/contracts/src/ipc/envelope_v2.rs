...
impl SchemaId {
    ...
    /// Runtime turn lifecycle/control events. This is deliberately distinct
    /// from the public Session Item/Turn event schema.
    pub const EVENT_RUNTIME_TURN_V1: &'static str = "aletheon.event.runtime_turn/v1";
    pub const EVENT_RUNTIME_AGENT_V1: &'static str = "aletheon.event.runtime_agent/v1";
