...
//!
//! Lives with the evaluation contracts so domain services (metacog, executive,
//! aletheon composition) can consume it without an `aletheon-config` dependency.

use super::{EvaluationContractError, EvaluationMode, EvaluationThresholds};
