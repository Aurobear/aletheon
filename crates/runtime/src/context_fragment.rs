...
//! validation from `::contracts::types::lifecycle`. At each turn-loop phase where
...
use ::contracts::{ItemPayload, SessionAppendStore, SessionId, TurnId, SESSION_SCHEMA_VERSION};
use anyhow::Result;
