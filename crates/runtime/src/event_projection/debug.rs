...
pub const ALL_EVENT_SCHEMAS: &[&str] = &[
    ...
    ::contracts::SchemaId::EVENT_MEMORY_STORED_V1,
    ::contracts::SchemaId::EVENT_SESSION_CREATED_V1,
    ::contracts::SchemaId::EVENT_SESSION_FORKED_V1,
    ::contracts::SchemaId::EVENT_MEMORY_CANDIDATE_V1,
    ::contracts::SchemaId::EVENT_EVALUATION_OBSERVED_V1,
    ::contracts::SchemaId::EVENT_AGORA_BROADCAST_V1,
    ::contracts::SchemaId::EVENT_RUNTIME_RESTART_V1,
];
