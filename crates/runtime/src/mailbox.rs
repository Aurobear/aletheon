//! Mailbox Service V2 — bounded async message passing for the canonical runtime.
//!
...
use ::contracts::ipc::envelope_v2::{DeliveryPattern, EnvelopeV2, MessageId, SchemaId, Target};
use ::contracts::{Clock, MonoTime};
use ::contracts::{NamespaceId, ProcessSignal};
...
mod tests {
    use super::*;
    use ::contracts::ipc::envelope_v2::{DeliveryPattern, SchemaId};
    use ::contracts::NamespaceId;
