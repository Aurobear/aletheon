//! Runtime-owned idempotent terminal Agent resource reclamation (RA-05).

use std::sync::Arc;

use ::contracts::AgentControlError;

use crate::{AgentResourceLease, AgentResourceLeaseKind, AgentRunProjection};
