...
use ::contracts::types::admission::PrincipalId;
use ::contracts::types::local_authority::{ConnectionId, ThreadId};
...
pub struct PromptEnvelope {
    ...
    pub content: String,
    /// Typed obligations travel with the durable prompt so a queued turn cannot
