...
//! from `runtime::compaction` to provide the executive persistence
//! consumer layer:
//!
...
use crate::compaction::{is_degenerate_summary, safe_tail_cut};
use ::contracts::{ContentBlock, ItemPayload, Message, Role};
use serde::Serialize;
...
///
/// This is a thin adapter from `::contracts::Message` to `ItemPayload`.
/// When the underlying items have already been projected into
/// messages, call `runtime::compaction::safe_tail_cut`
/// directly.
