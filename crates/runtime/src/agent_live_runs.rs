...
use crate::agent_resources::BackgroundResourceRegistration;

#[async_trait::async_trait]
impl crate::SettlementQuiescePort for LiveAgentRun {
    async fn begin_quiescing(&self) -> Vec<::contracts::BackgroundResourceDecl> {
        LiveAgentRun::begin_quiescing(self).await
    }
}
                ...
                (
                    ...
                    ManagedResourceState {
                        ...
                        notification_target: (declaration.class
                            == ::contracts::AgentResourceClass::NotificationRoute)
