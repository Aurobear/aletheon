//! Runtime-owned Agent lifecycle reducer (RA-05).
//!
//! Agent state transitions are Runtime authority.  Executive may retain a
//! compatibility facade and project the resulting status, but it must not
//! own a second reducer.

use ::contracts::AgentRunStatus;
use std::fmt;
