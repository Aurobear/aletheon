        ...
        let result = capability
            .invoke(
                ...
                ::contracts::CapabilityCall {
                    ...
                    process_id: ::contracts::ProcessId::default(),
...
mod tests {
    ...
    impl ToolExecutor for RejectExecutor {
        async fn execute_with_permit(
            &self,
            request: &::contracts::CapabilityRequest,
            _permit: &::contracts::ExecutionPermit,
        ) -> ::contracts::CapabilityResult {
            ::contracts::CapabilityResult {
    ...
    fn corpus(with_tool: bool) -> (Arc<dyn corpus::CorpusService>, corpus::ExtensionGrant) {
        ...
        let catalog = if with_tool {
            capabilities.push(::contracts::CapabilityId("bash_exec".into()));
            corpus::ExtensionCatalog::new([corpus::ExtensionDescriptor::new(
                corpus::ExtensionKind::Tool,
                "bash_exec",
                "1",
                "execute bash",
                ::contracts::CapabilityId("bash_exec".into()),
                ::contracts::types::admission::RiskLevel::SystemModify,
            )
            .unwrap()
            .with_tool_definition(::contracts::ToolDefinition {
                name: "bash_exec".into(),
