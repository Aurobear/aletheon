...
pub type TestTurnRunner = Arc<
    dyn Fn(
            ...
            'static,
            anyhow::Result<application::turn::coordinator::TurnExecution>,
        > + Send
        + Sync,
>;
...
pub(crate) struct DaemonTurnResources {
    ...
    pub session_service: Arc<::runtime::session_service::SessionService>,
...
pub struct DaemonTurnOrchestrator {
    ...
    pub turn_engine: Option<Arc<dyn application::turn::TurnEngine>>,
    pub coordinator: Arc<TurnCoordinator>,
    pub session_service: Arc<::runtime::session_service::SessionService>,
    #[allow(dead_code)]
    pub grok_hardening: GrokHardeningConfig,
...
impl DaemonTurnOrchestrator {
    ...
    pub fn compose(
        ...
        session_service: Arc<::runtime::session_service::SessionService>,
    ...
    pub(crate) fn new(resources: DaemonTurnResources) -> Self {
        let turn_engine = Arc::new(crate::daemon::turn_engine::DaemonTurnEngine::new(
