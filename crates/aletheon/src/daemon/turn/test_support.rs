...
use application::turn::ports::ActiveAgentProfilePort;
...
impl DaemonTurnTestBuilder {
    ...
    pub(crate) async fn build(self) -> DaemonTurnTestHarness {
        ...
        let authority = Arc::new(
            adapters_sqlite::session::event_sourced_store::EventSourcedSessionStore::new(
                read_store,
                spine,
                projections,
            ),
        ...
        let coordinator = Arc::new(
            application::turn::coordinator::TurnCoordinator::from_resources(
                application::turn::coordinator::TurnCoordinatorResources {
                    clock: kernel.clock(),
                    timer: Arc::new(
                        crate::host::runtime::turn_operations::KernelTurnTimer::system(),
                    ),
                    operations: Arc::new(
                    ...
                    settings: application::turn::settings::TurnCoordinatorSettings::default(),
