//! Aletheon-owned session extension policy and activation boundary.
...
use corpus::{
    ActivationReceipt, ActivationRequest, CorpusService, ExtensionGrant, ExtensionId,
    ExtensionSnapshot,
};
use runtime::{
...
/// The only Aletheon service that converts catalog discovery into session activation.
