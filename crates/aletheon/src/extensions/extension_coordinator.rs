...
use gateway::protocol::extension::{ExtensionMutationReceiptV1, EXTENSION_PROTOCOL_SCHEMA_V1};
...
impl ExtensionCoordinator {
    ...
    fn complete_receipt(
        ...
        store.append_evidence(&ExtensionEvidenceEvent {
            ...
            occurred_at: ::contracts::wall_to_datetime(self.clock.wall_now()).to_rfc3339(),
        })?;
        Ok(receipt)
    }
