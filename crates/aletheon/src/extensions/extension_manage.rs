...
pub struct ExtensionApprovalRequest {
    ...
    pub version: String,
    pub added_permissions: corpus::extension::package::PermissionRequestSet,
...
mod tests {
    ...
    fn record(hash: &str, version: &str, installed_at: &str) -> InstalledPackageRecord {
        InstalledPackageRecord {
            ...
            assets: Vec::new(),
            requested_permissions: corpus::extension::package::PermissionRequestSet::default(),
    ...
    fn lifecycle_updates_durable_state_and_rolls_back() {
        ...
        service
            ...
            .write_activation(&ActivationRecord {
                ...
                granted_permissions: corpus::extension::package::PermissionRequestSet::default(),
    ...
    fn permission_elevation_requires_explicit_approval_and_preserves_old_state() {
        ...
        candidate.assets.push(corpus::extension::package::AssetRef {
...
fn approval_request(
    ...
    ExtensionApprovalRequest {
        ...
        added_permissions: corpus::extension::package::PermissionRequestSet {
...
fn permission_request_is_empty(
    permissions: &corpus::extension::package::PermissionRequestSet,
) -> bool {
    permissions
        .filesystem
        .as_ref()
