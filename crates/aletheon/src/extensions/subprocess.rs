//! Subprocess runtime adapter for extension executable assets.
//!
...
use ::contracts::{AgentHandle, AgentSpawnRequest, IsolationLevel, SandboxBackend, SandboxConfig};
...
pub struct SubprocessAgentRuntimeProvider {
    ...
    sessions: Mutex<HashMap<::contracts::AgentId, ProviderSession>>,
...
mod tests {
    use super::*;
    use ::contracts::ResolvedSandboxPolicy;
    ...
    async fn isolated_fixture(
        ...
        let workspace =
            ::contracts::WorkspacePolicy::from_resolved_roots(work.path().to_path_buf(), vec![])
                .unwrap();
    ...
    fn spawn_request() -> AgentSpawnRequest {
        AgentSpawnRequest {
            root_agent_id: ::contracts::AgentId(uuid::Uuid::new_v4()),
            parent_agent_id: None,
            parent_process_id: None,
            profile_id: ::contracts::AgentProfileId("test".into()),
            runtime_id: ::contracts::RuntimeId("runtime.generic".into()),
            trusted_workspace: None,
            delegator_authority: None,
            cognitive_binding: None,
            task: "test".into(),
            context: ::contracts::AgentContextFork::default(),
