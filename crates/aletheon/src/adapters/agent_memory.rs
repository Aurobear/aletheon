...
use ::contracts::{AgentControlError, AgentControlErrorKind, PrincipalId};
...
use runtime::{AgentContextProjection, AgentRuntimeEvent, AgentRuntimeEventSink as AgentEventSink};
...
pub(crate) struct ReviewedChildMemoryDraft {
    ...
    root_content: ::contracts::ContentId,
    broadcast: ::contracts::BroadcastEpoch,
    selected_candidate: ::contracts::ContentId,
...
mod tests {
    use super::*;
    use ::contracts::{AgentId, AgentTaskId, OperationId, ProcessId};
    ...
    fn terminal_event_becomes_durable_goal_outcome() {
        ...
        let event = AgentRuntimeEvent::Terminal {
            ...
            result: Some(::contracts::AgentResult {
