...
/// Typed RA-03 Session writer cutover mode.
///
/// Serde rejects unknown values while loading the configuration layer, so an
/// operator typo cannot silently reopen the legacy writer.
