//! Agent-level configuration: CognitiveRuntimeConfig, AgentConfig, HooksConfig,
//! PerceptionConfig, AgentLoopConfig, and CircuitBreakerConfig.
//!
//! AgentConfig, PerceptionConfig, and EvolutionSettings are re-exported from aletheon-cognit.
//! CognitiveRuntimeConfig and the host-side loop settings are owned by the
//! Aletheon composition root.
...
pub struct CognitiveRuntimeConfig {
...
impl Default for CognitiveRuntimeConfig {
    fn default() -> Self {
        Self {
            max_iterations: 50,
            ...
            conscious_arbitration_mode: ::contracts::ConsciousArbitrationMode::Observe,
...
impl From<CognitiveRuntimeConfig> for application::turn::settings::TurnRuntimeSettings {
    fn from(config: CognitiveRuntimeConfig) -> Self {
        Self {
