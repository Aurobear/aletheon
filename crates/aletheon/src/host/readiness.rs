...
mod tests {
    ...
    async fn readiness_probe_negotiates_typed_runtime_facts() {
        ...
        let server = tokio::spawn(async move {
            ...
            let event =
                ClientEvent::InitializeResponse(::contracts::protocol::client::InitializedResult {
                    ...
                    principal_id: ::contracts::PrincipalId::local_uid(1000),
                    os_principal: ::contracts::LocalOsPrincipal {
                        uid: 1000,
                        gid: 1000,
                    },
