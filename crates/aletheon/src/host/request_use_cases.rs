...
use crate::host::admin_service::BackgroundWorkerPort;
...
pub struct ProductionHealthUseCases {
    ...
    agent_recovery: crate::composition::agent_control::AgentRecoveryReport,
}
...
pub struct ProductionSessionLifecycle {
    ...
    approvals: crate::host::admin_service::ScopedApprovalCache,
