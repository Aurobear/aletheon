...
pub(crate) struct MemoryGroup {
    ...
    pub objective_store: Arc<Mutex<adapters_sqlite::goal::ObjectiveStore>>,
...
pub(crate) struct SecurityGroup {
    ...
    pub pending_approvals: crate::host::admin_service::PendingApprovals,
    pub session_approvals: crate::host::admin_service::ScopedApprovalCache,
}
