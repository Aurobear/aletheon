...
use cognit::domain::{ExecutionResult, ReflectionEntry, ReflectionTrigger};
    ...
    pub fn negativity_from_stimmung(mood: &Stimmung) -> Option<NegativitySignal> {
        match mood {
            Stimmung::Angst { facing } => Some(NegativitySignal {
                ...
                depth: match facing {
                    ::contracts::dasein::AngstSource::Nothingness => 1.0,
                    ::contracts::dasein::AngstSource::Finitude => 0.9,
                    ::contracts::dasein::AngstSource::Freedom => 0.8,
                    ::contracts::dasein::AngstSource::Responsibility => 0.7,
                },
