...
use crate::wiring::application::turn_coordinator::{
    cancelled_result, TurnCoordinator, TurnExecution,
};
use crate::wiring::application::turn_engine::{
...
use crate::wiring::composition::turn_service::RecordingTurnServices;
use crate::wiring::composition::TurnService;
...
impl ExecSessionBuilder {
    ...
    pub async fn build(
        ...
        let inference = self.inference.unwrap_or_else(|| {
            ...
            Arc::new(crate::wiring::core_rpc::CoreRpcClient::new(socket))
        });
        ...
        let corpus_composition = crate::wiring::composition::exec_corpus::compose_exec_corpus(
            audit_path,
            &self.sandbox,
            clock.clone(),
            session_id.clone(),
        ...
        let coordinator = Arc::new(
            crate::wiring::composition::turn_coordinator::compose_turn_coordinator(
                kernel.clone(),
