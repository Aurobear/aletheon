...
use crate::config::SupplementalDestinationAttestationConfig;
...
impl crate::wiring::application::memory_gateway::SupplementalBindingNegotiator
...
#[async_trait::async_trait]
impl crate::wiring::application::memory_gateway::SupplementalBindingRecallPort
    for McpSupplementalBindingNegotiator
{
    async fn recall(
        &self,
        ...
        {
            let grant =
                match crate::wiring::application::memory_gateway::SupplementalBindingNegotiator::negotiate(
                    self,
                    handle,
                    &binding.backend_id,
                    expected_source,
