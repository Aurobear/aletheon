...
use crate::wiring::adapters::inference::anthropic::AnthropicProvider;
use crate::wiring::adapters::inference::ollama::OllamaProvider;
use crate::wiring::adapters::inference::openai_provider::OpenAiProvider;
use crate::wiring::adapters::inference::provider::LlmProvider;
use crate::wiring::adapters::inference::{
    backpressure,
    provider::{InferenceFailure, InferenceFailureKind},
};
use cognit::config::{ProviderConfig, ProviderPricing, ProviderTimeoutConfig, Transport};

use cognit::composition::model_catalog;
