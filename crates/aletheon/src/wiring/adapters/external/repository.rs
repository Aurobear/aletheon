...
use application::{
    ...
    ExternalIdentityState, ExternalProviderId, GrantState,
};
...
impl From<application::ExternalIdentityContractError> for ExternalRepositoryError {
    fn from(error: application::ExternalIdentityContractError) -> Self {
