...
use application::{ExternalCapabilityId, ExternalIdentityId, ExternalIdentityState, GrantState};
...
impl GoogleIntegration {
    ...
    pub async fn complete_authorization(
        ...
        alias: Option<String>,
        now_ms: i64,
    ) -> anyhow::Result<(application::ExternalIdentity, application::CapabilityGrant)> {
        let owner = self
            .pending_owners
            .lock()
            .await
...
#[async_trait]
impl gateway::ports::ExternalAccountDirectory for GoogleIntegration {
...
impl GoogleAccountResolverAdapter {
...
#[async_trait]
impl GoogleAccountResolver for GoogleAccountResolverAdapter {
...
impl GoogleCredentialSourceAdapter {
    pub fn new(
        repository: Arc<std::sync::Mutex<ExternalIdentityRepository>>,
        oauth: Arc<Mutex<GoogleOAuthProvider>>,
    ) -> Self {
...
#[async_trait]
impl GoogleCredentialSource for GoogleCredentialSourceAdapter {
