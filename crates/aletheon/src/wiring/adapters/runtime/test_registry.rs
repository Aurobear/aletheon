...
use crate::wiring::application::agent_control::AgentRuntimeLauncher;
...
impl AgentExecutionRegistry {
    ...
    /// All registered runtime IDs, including explicit compatibility routes
...
impl crate::wiring::application::agent_control::CompatibilityRuntimeCatalog
    for AgentExecutionRegistry
{
