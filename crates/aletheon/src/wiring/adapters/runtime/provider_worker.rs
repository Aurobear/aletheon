...
impl ProviderWorkerRuntime {
    ...
    async fn run_attempt_with_context(
        ...
        execution: Option<runtime::DelegateExecutionContext>,
...
impl ProviderWorkerRuntime {
    pub async fn run(&self, task: &str, cancel: CancellationToken) -> Result<String, String> {
    ...
    pub async fn run_in_context(
        ...
        task: &str,
        cancel: CancellationToken,
        context: runtime::DelegateExecutionContext,
    ...
    pub async fn run_attempt_in_context(
        &self,
        task: &str,
        cancel: CancellationToken,
        context: runtime::DelegateExecutionContext,
...
#[async_trait]
impl runtime::DelegateTaskBackend for ProviderWorkerRuntime {
...
impl ProviderWorkerRuntime {
    async fn run_loop_inner(
        ...
        let mut observability = ::contracts::attempt::RuntimeObservability {
        ...
        let approval_authority = execution.as_ref().map(|context| {
            ...
            (
                ...
                ::contracts::ThreadId(context.session_id.clone()),
                ::contracts::TurnId::new(),
                ::contracts::WorkspacePolicy::from_resolved_roots(working_dir, vec![])
...
mod tests {
    use super::*;
    use ::contracts::tool::{Tool, ToolContext, ToolResult, ToolResultMeta};
    ...
    impl CapabilityService for TestCapabilityService {
        async fn invoke(
            ...
            ::contracts::CapabilityResult {
                ...
                audit_id: Some(::contracts::AuditEventId::new()),
                patch_delta: None,
