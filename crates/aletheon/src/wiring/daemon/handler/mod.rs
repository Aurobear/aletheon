...
pub struct RequestHandler {
    ...
    pub(crate) workspace_trust: Arc<crate::wiring::workspace_trust::WorkspaceTrustResolver>,
...
impl RequestHandler {
    ...
    pub(crate) async fn resolve_versioned_approval(
        ...
        let decision = match request.decision {
            ::contracts::protocol::client::ApprovalDecisionRequest::Approve => {
                adapters_sqlite::approval_repository::ApprovalDecision::Approve
            }
            ::contracts::protocol::client::ApprovalDecisionRequest::Reject => {
                adapters_sqlite::approval_repository::ApprovalDecision::Reject {
        ...
        self.ports
            .approvals
            .resolve(crate::wiring::approval_service::ResolveApprovalRequest {
                context: crate::wiring::approval_service::ApprovalContext {
    ...
    async fn handle_workspace_trust_evaluate(
        ...
        let decision = self
            ...
            .evaluate(
                connection.principal_id.clone(),
                crate::wiring::workspace_trust::workspace_identity(workspace.cwd()),
                application::workspace_trust::ClientMode::Interactive,
                crate::wiring::workspace_trust::is_broad_unrecordable_root(workspace.cwd()),
                unix_now(),
            )
            .await;
    ...
    pub(crate) async fn execute_explicit_chat(
        ...
        let trust_decision = self
            ...
            .evaluate(
                ...
                crate::wiring::workspace_trust::workspace_identity(context.workspace.cwd()),
                application::workspace_trust::ClientMode::Headless,
                crate::wiring::workspace_trust::is_broad_unrecordable_root(context.workspace.cwd()),
            ...
            .await;
        context.repo_hooks_trusted = crate::wiring::workspace_trust::source_is_granted(
            &trust_decision,
