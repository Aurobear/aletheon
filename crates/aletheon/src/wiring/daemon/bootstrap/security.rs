...
pub(super) fn build_tool_runner(
    ...
    let front_backend: Option<Box<dyn ::contracts::SandboxBackend>> = if grok_hardening.execd {
        ...
        let backend = corpus::security::execd_backend::ExecdSandboxBackend::new(
            corpus::security::execd_backend::ExecdConfig {
