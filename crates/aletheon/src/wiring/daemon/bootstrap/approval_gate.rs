...
) -> Arc<crate::wiring::workspace_trust::WorkspaceTrustResolver> {
    let mut resolver = crate::wiring::workspace_trust::WorkspaceTrustResolver::new(
        Arc::new(crate::wiring::workspace_trust::FileTrustStore::new(
            data_dir.join("workspace-trust-receipts.json"),
        )),
        Arc::new(crate::wiring::workspace_trust::KnownConfigDiscoverer::default()),
...
pub(crate) struct DurableSocketApprovalGate {
    ...
    pub(crate) session_grants: crate::wiring::application::admin_service::ScopedApprovalCache,
}
