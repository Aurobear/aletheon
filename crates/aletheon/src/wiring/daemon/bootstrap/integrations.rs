...
pub(super) struct GoogleCompositionInput<'a> {
    ...
    pub(super) storage_quota: Option<platform::storage_quota::StorageQuota>,
    pub(super) config: Option<&'a crate::config::ResolvedGoogleIntegration>,
}

#[derive(Default)]
pub(super) struct GoogleComposition {
    pub(super) integration: Option<Arc<crate::wiring::adapters::external::GoogleIntegration>>,
    pub(super) sync: Option<crate::wiring::adapters::google::GoogleSyncHandle>,
    pub(super) sync_store:
        Option<Arc<std::sync::Mutex<crate::wiring::adapters::google::GoogleSyncStore>>>,
    pub(super) gmail_ingress:
        Option<Arc<crate::wiring::adapters::channel::gmail::GmailGoalEventIngress>>,
