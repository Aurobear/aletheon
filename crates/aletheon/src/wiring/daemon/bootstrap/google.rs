...
pub(super) type ConfiguredGoogleReadTools = (
    ...
    crate::wiring::adapters::google::GoogleSyncHandle,
    Arc<std::sync::Mutex<crate::wiring::adapters::google::GoogleSyncStore>>,
...
pub(super) fn register_configured_external_read_tools(
    ...
    let store = Arc::new(std::sync::Mutex::new(
        crate::wiring::adapters::google::GoogleSyncStore::open(objective_db_path)?,
    ));
    let mut manager = crate::wiring::adapters::google::GoogleSyncManager::new(
        store.clone(),
        format!("daemon-{}", uuid::Uuid::new_v4()),
        clock.clone(),
        crate::wiring::adapters::google::GoogleSyncManagerConfig::default(),
    )?;
    ...
    for (identity, grant) in active_bindings {
        ...
        {
            manager.register(crate::wiring::adapters::google::GoogleSyncRegistration {
                principal: identity.principal_id.clone(),
                account_id: identity.id,
                stream: crate::wiring::adapters::google::SyncStream::GmailHistory,
                initial_cursor: None,
                cursor_generation: 1,
                poller: Arc::new(crate::wiring::adapters::google::GmailHistoryPoller(
            ...
            .contains(&application::ExternalCapabilityId::new("calendar.read").unwrap())
        {
            manager.register(crate::wiring::adapters::google::GoogleSyncRegistration {
                principal: identity.principal_id.clone(),
                account_id: identity.id,
                stream: crate::wiring::adapters::google::SyncStream::Calendar,
                initial_cursor: None,
                cursor_generation: 1,
                poller: Arc::new(crate::wiring::adapters::google::CalendarDeltaPoller(
                ...
                .contains(&application::ExternalCapabilityId::new("file.read").unwrap())
        {
            manager.register(crate::wiring::adapters::google::GoogleSyncRegistration {
                ...
                account_id: identity.id,
                stream: crate::wiring::adapters::google::SyncStream::DriveChanges,
                initial_cursor: None,
                cursor_generation: 1,
                poller: Arc::new(crate::wiring::adapters::google::DriveChangesPoller(
