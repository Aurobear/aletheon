...
use ::contracts::{
    EvaluationReceipt, EvaluationReceiptId, OperationKind, OperationRequest,
...
impl EvaluationService {
    ...
    pub fn capability_rollup_snapshot(
        ...
        crate::wiring::application::capability_benchmark::CapabilityRollupKey,
        crate::wiring::application::capability_benchmark::CapabilityReceiptRollup,
    > {
    ...
    pub async fn evaluate(
        ...
        parent_turn_operation: ::contracts::OperationId,
