            ...
            .submit_with_receipt(
                ...
                move |request, cancel| async move {
                    ...
                    let engine_result = turn_engine
                        .execute(
                            crate::wiring::application::turn_engine::TurnEngineRequest {
                            ...
                            crate::wiring::application::turn_engine::TurnEngineContext {
...
mod tests {
    use super::*;
    use crate::wiring::application::daemon_turn::test_support::DaemonTurnTestBuilder;
    ...
    fn unavailable_turn_error_keeps_typed_json_rpc_contract() {
        let error = anyhow::Error::new(
            crate::wiring::application::turn_engine::TurnEngineError::Unavailable(
    ...
    fn turn_engine_error_variants_preserve_machine_code_and_retryability() {
        use crate::wiring::application::turn_engine::TurnEngineError;
