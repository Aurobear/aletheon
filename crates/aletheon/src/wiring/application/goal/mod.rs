...
mod budget;
pub mod coordinator;
pub(crate) use adapters_sqlite::schema_migrations as migrations;
...
pub use application::goal_attempt::GoalAttempt;
pub use application::goal_frame::{GoalAttemptSummary, GoalFrame, GoalRemainingBudget};
pub use application::goal_projection::GoalProjectionEvidence;
pub use application::goal_retry::{RetryDecision, RetryPolicy};
pub use attempt_coordinator::{
    AttemptCoordinationOutcome, AttemptCoordinator, AttemptCoordinatorError, AttemptExecutor,
    AttemptRequest, CodingVerifier, GoalEvaluationFeedback, GoalEvaluationProjectionSink,
};
pub use runtime_executor::{GoalAttemptBackend, RuntimeGoalAttemptExecutor};
pub use summary::{
