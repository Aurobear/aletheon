...
use crate::wiring::application::approval::{
    ApplyCoordinator, ApplyCoordinatorConfig, ManagedWorktreeCleaner,
};
use crate::wiring::application::goal::budget::GoalBudgetRequest;
use crate::wiring::application::goal::transition::GoalTransitionError;
use crate::wiring::application::goal::{
...
use crate::wiring::application::memory_projection::{
    ApprovedArchitectureDecision, MemoryProjection, ProjectionStatus,
};
use ::contracts::goal::{GoalId, GoalSnapshot, GoalState, GoalWaitReason};
use ::contracts::Clock;
use ::contracts::ProcessId;
use ::contracts::{ApprovalId, PrincipalId};
...
mod tests {
    use super::*;
    use ::contracts::goal::{GoalBudget, GoalSpec};
