...
use crate::wiring::application::request_use_cases::MemoryAdminUseCases;
...
pub struct AdminResources {
    ...
    pub agent_runs: Option<Arc<dyn crate::wiring::application::agent_control::AgentRunProjection>>,
