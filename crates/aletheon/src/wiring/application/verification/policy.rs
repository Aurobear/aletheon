...
use ::contracts::{VerificationCheck, VerificationReport, VerificationSeverity};
...
mod tests {
    use super::*;
    use crate::wiring::application::verification::{CapabilityAuditSummary, VerificationSelection};
    use ::contracts::{AttemptId, CodingJobId, GoalId};
