...
use agora::conscious_field::{proposal_salience, should_defer};
...
pub struct ConsciousActionBridge {
    ...
    arbitration_mode: ::contracts::ConsciousArbitrationMode,
}
...
impl ConsciousActionBridge {
    ...
    pub fn with_arbitration_mode(mut self, mode: ::contracts::ConsciousArbitrationMode) -> Self {
    ...
    fn expiry(&self, now: ::contracts::MonoTime) -> MonoDeadline {
        MonoDeadline::after(
            now,
...
impl GovernedActionLoop for ConsciousActionBridge {
    fn arbitration_mode(&self) -> ::contracts::ConsciousArbitrationMode {
    ...
    async fn observe_modulation(
        &self,
        mode: ::contracts::ConsciousArbitrationMode,
        call: &CapabilityCall,
