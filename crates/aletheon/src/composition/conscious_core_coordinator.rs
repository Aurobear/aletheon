//! Aletheon owner of the recurrent Dasein–Agora workspace loop.

use agora::ConsciousTraceEvent;
use agora::{AgoraOperation, AgoraProposal, AgoraService, AgoraViewRequest};
...
use ::contracts::{
    ...
    ConsciousFieldReadout, ConsciousProcessor, ContentId, ContextProjectionReceipt, GoalFrame,
...
use metacog::evaluation::{FieldMetricHistory, FieldMetricIndicators, FieldMetricSnapshot};
...
use agora::conscious_core_ports::{
    ...
    ConsciousCandidatePort, ConsciousCoreConfig, ConsciousCycleReceipt, DaseinIntegration,
    DaseinWorkspacePort, ProcessorCycleStatus, ProcessorRegistration,
};
...
impl ConsciousCoreCoordinator {
    ...
    async fn commit_attention(
        ...
        let permit = agora::WorkspaceCommitPermit::issue_for(&proposal, deadline)?;
    ...
    async fn deliver_processors(
        &self,
        broadcast: &WorkspaceBroadcast,
        dasein_version: ::contracts::dasein::SelfVersion,
        recurrence_depth: u16,
        deadline: MonoDeadline,
