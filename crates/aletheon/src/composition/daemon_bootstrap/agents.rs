...
pub(super) struct AgentCompositionInput<'a> {
    ...
    pub(super) runtime_config: &'a crate::config::CognitiveRuntimeConfig,
    pub(super) profiles_config: &'a crate::config::AgentProfilesConfig,
}

pub(super) struct AgentComposition {
    pub(super) profiles: Arc<crate::host::runtime::AgentProfileRegistry>,
    pub(super) tool_profiles: HashMap<String, ::contracts::AgentProfile>,
...
mod tests {
    ...
    impl InferencePort for NoopInference {
        ...
        ) -> Result<::contracts::LlmResponse, InferenceError> {
        ...
        async fn stream(
            &self,
            _request: CoreInferenceRequest,
        ) -> Result<::contracts::LlmStream, InferenceError> {
            Err(anyhow::anyhow!("unused test inference").into())
        }
    }
    ...
    async fn compose_test_profiles(
        ...
        let profiles_config = crate::config::AgentProfilesConfig {
        ...
        compose(AgentCompositionInput {
            ...
            runtime_config: &crate::config::CognitiveRuntimeConfig::default(),
    ...
    fn quarantine_and_known_good_snapshots_are_durable() {
        ...
        persist_quarantine(
            &state,
            &[
                crate::composition::daemon_bootstrap::runtime::QuarantinedProfile {
                    name: "broken".into(),
