...
impl crate::host::admin_service::ExtensionSkillCatalogPort for ExtensionSkillCatalog {
    async fn list_extension_skills(&self) -> Vec<crate::host::admin_service::SkillDescriptor> {
        ...
        snapshot
            ...
            .filter_map(|skill| {
                ...
                Some(crate::host::admin_service::SkillDescriptor {
