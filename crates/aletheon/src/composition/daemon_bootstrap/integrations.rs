...
pub(super) struct GoogleComposition {
    ...
    pub(super) sync: Option<adapters_google::GoogleSyncHandle>,
    pub(super) sync_store: Option<Arc<std::sync::Mutex<adapters_google::GoogleSyncStore>>>,
    pub(super) gmail_ingress: Option<Arc<adapters_google::gmail::GmailGoalEventIngress>>,
