...
pub(super) struct ProfileLoadResult {
    pub registry: Arc<crate::host::runtime::AgentProfileRegistry>,
...
async fn load_agent_profiles_from_loader(
    ...
    let catalog = profile_definitions
        ...
        .collect::<HashMap<_, _>>();
    let registry = Arc::new(crate::host::runtime::AgentProfileRegistry::default());
    ...
    for role in loader.list() {
        ...
        registry.register(crate::host::runtime::ResolvedAgentProfile {
...
pub(super) async fn register_agent_tools(
    tools: crate::host::domain::ToolRegistryHandle,
    ...
    if !profiles.is_empty() {
        ...
        let agent_tool = corpus::tools::tools::agent_tool::AgentTool::new(
            profiles,
            agent_control,
            crate::host::runtime::NativeCognitRuntime::runtime_id(),
        );
...
use adapters_agent_backend::ProviderWorkerRuntime;
