...
pub struct PackageProfileRuntime {
    registry: Arc<crate::host::runtime::AgentProfileRegistry>,
...
impl PackageProfileRuntime {
    ...
    ) -> Result<Vec<(String, crate::host::runtime::ResolvedAgentProfile)>> {
    ...
    fn publish(
        &self,
        owners: &[String],
        prepared: Vec<(String, crate::host::runtime::ResolvedAgentProfile)>,
    ) -> Result<()> {
        self.registry
