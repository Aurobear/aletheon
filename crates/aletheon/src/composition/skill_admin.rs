...
use crate::host::admin_service::{AdminServiceError, SkillAdminPort};
...
impl SkillAdminPort for DefaultSkillAdmin {
    ...
    async fn list(&self) -> Vec<crate::host::admin_service::SkillDescriptor> {
        self.loader
            .lock()
            .await
            .skills()
            .iter()
            .map(|s| crate::host::admin_service::SkillDescriptor {
