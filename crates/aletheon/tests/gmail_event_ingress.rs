...
use corpus::tools::google::{
    ExternalEvent, ExternalEventDraft, ExternalEventEnvelope, ExternalObjectRef, ExternalRecordRef,
    MailChange, MailMessageSummary, OpaqueCursor, OpaqueProviderObjectId,
};
use corpus::tools::google::{
...
async fn durable_mail_event_fetches_authenticates_and_creates_one_non_executable_draft() {
    ...
    assert_eq!(goals[0].state, ::contracts::GoalState::Draft);
