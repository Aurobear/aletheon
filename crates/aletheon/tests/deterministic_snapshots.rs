...
use ::contracts::{AgoraSpaceId, BroadcastEpoch, ContentId, ContextProjectionReceipt};
...
fn app_config_schema_matches_checked_in_repository_snapshot() {
    let generated = aletheon::config::schema::generated_schema_json();
    assert_eq!(
        generated,
        aletheon::config::schema::generated_schema_json(),
