use ::contracts::tool::ToolContext;
...
use corpus::tools::google::{
    CalendarEntryPage, CalendarQuery, ExternalRecordRef, MailMessage, MailMessagePage,
    MailMessageSummary, MailQuery, OpaqueCursor, OpaqueProviderObjectId,
};
