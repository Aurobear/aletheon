...
impl WorldStatePort for DirectWorld {
    ...
    async fn observe_until(
        ...
        self.latest(device, ::contracts::types::world_state::ANY_SCHEMA)
            .await
    }
}
...
async fn robot_turn_drives_harness_to_completion() {
    ...
    let report: ::contracts::types::episode_report::EpisodeReport =
...
async fn pre_cancelled_robot_turn_safe_stops_and_returns_typed_report() {
    ...
    assert_eq!(
        ...
        ::contracts::types::episode_report::SafeStopOutcome::Succeeded
    );
    assert_eq!(
    ...
    assert_eq!(
        ...
        ::contracts::types::robot_failure::RobotFailureClass::Cancelled
    );
    assert_eq!(
...
struct RecordingEpisodes {
    attempts: Mutex<Vec<::contracts::types::episode_report::AttemptRecord>>,
...
impl EpisodeAuditPort for RecordingAudit {
    async fn record(
        &self,
        report: &::contracts::types::episode_report::SettledEpisodeReport,
    ) -> Result<(), String> {
...
impl EpisodeSink for RecordingEpisodes {
    async fn append_attempt(
        ...
        let mut record = ::contracts::types::episode_report::AttemptRecord::from_verification(
            attempt,
