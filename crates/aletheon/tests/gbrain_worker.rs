...
use mnemosyne::supplemental::SupplementalDeliveryWorker;
...
#[test]
fn mnemosyne_worker_only_schedules_reconciliation() {
    let source = include_str!("../../mnemosyne/src/backends/supplemental/worker.rs");
    for forbidden in [
        ".claim(",
        ".acknowledge(",
        ".retry(",
        ...
        assert!(
            ...
            "worker retained Supplemental memory-domain operation: {forbidden}"
        );
    }
