...
async fn same_session_concurrent_appends_retry_to_one_contiguous_sequence() {
    ...
    let baseline = adapters_sqlite::session::event_sourced_store::session_append_metrics();
    ...
    let metrics = adapters_sqlite::session::event_sourced_store::session_append_metrics();
