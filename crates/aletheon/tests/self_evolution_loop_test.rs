...
use ::contracts::{LlmProvider, StopReason};
...
use dasein::core::evolution_input::{EvolutionTrigger, LearnedRuleSnapshot};
...
async fn test_mutation_approver_validates_intents() -> Result<()> {
    ...
    let trigger = EvolutionTrigger {
        ...
        current_rules_snapshot: vec![LearnedRuleSnapshot {
            id: Uuid::new_v4(),
    ...
    let unknown_trigger = EvolutionTrigger {
