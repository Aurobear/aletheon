...
use adapters_sqlite::approval_repository::{ApprovalDecision, ApprovalRepository, ApprovalResolutionContext};
...
fn read_only_default_creates_local_artifact_and_never_authorizes_gmail_send() {
    ...
    assert_eq!(
        ...
        adapters_sqlite::artifact::ArtifactScanStatus::Clean
    );
