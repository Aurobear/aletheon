...
pub trait VerificationWorkspaceReader: Send + Sync {
    fn read_utf8(
        &self,
...
pub struct VerificationService {
    ...
    commands: Arc<dyn VerificationCommandExecutor>,
    workspace: Arc<dyn VerificationWorkspaceReader>,
    ...
    pub async fn verify(
        ...
        for kind in context.selection.checks() {
            let check = match kind {
                ...
                VerificationCheckKind::ArchitectureReview => checks::architecture_review(
                    context,
