...
//! callers persist [`GoalWaitReason::Backoff`](::contracts::GoalWaitReason::Backoff)
//! using their injected wall clock before scheduling a later attempt.

use ::contracts::{AttemptEvidence, CognitiveRole, FailureClass, RuntimeFailure, RuntimeId};
...
mod tests {
    use super::*;
    use ::contracts::{AttemptUsage, FailureClass};
