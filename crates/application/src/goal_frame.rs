...
use ::contracts::{AttemptEvidence, GoalBudget, GoalSnapshot};
...
fn sanitize(value: &str, max_bytes: usize) -> String {
    ...
    ::contracts::RuntimeFailure {
        class: ::contracts::FailureClass::ProviderPermanent,
        message: value.into(),
        retryable: false,
...
mod tests {
    ...
    fn goal() -> GoalSnapshot {
        GoalSnapshot {
            ...
            state: ::contracts::GoalState::Running,
            spec: GoalSpec {
    ...
    fn attempt(sequence: u32) -> GoalAttempt {
        GoalAttempt {
            ...
            failure: Some(RuntimeFailure {
                class: ::contracts::FailureClass::TestFailure,
