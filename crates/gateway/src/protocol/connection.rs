...
use ::contracts::protocol::client::{
    negotiate_protocol_version, ClientCapabilities, ClientRequest,
};
...
pub struct ProtocolTransition {
    pub next_state: ConnectionProtocolState,
    pub action: ProtocolAction,
}

pub fn reduce_protocol(
...
impl ConnectionProtocolState {
    pub fn accept(&mut self, request: &ClientRequest) -> anyhow::Result<ProtocolAction> {
        self.accept_with_capabilities(request, false, false)
    }

    pub fn accept_with_capabilities(
        &mut self,
...
mod tests {
    ...
    fn rejects_memory_requests_when_gateway_capability_was_not_negotiated() {
        ...
        assert!(state
            .accept(&ClientRequest::MemoryReceiptGet(
                ::contracts::protocol::memory::MemoryReceiptGetRequestV1 {
    ...
    fn maintenance_capability_is_connection_role_scoped() {
        let initialize =
            ClientRequest::Initialize(::contracts::protocol::client::InitializeParams {
        ...
        let request = ClientRequest::MemoryMaintenanceStatus(
            ::contracts::protocol::memory_maintenance::MemoryMaintenanceStatusRequestV1 {
    ...
    fn memory_admin_capability_is_connection_role_scoped() {
        ...
        let request = ClientRequest::MemoryWorkspaceUnbind(
            ::contracts::protocol::memory::MemoryWorkspaceUnbindRequestV1 {
