//! Versioned Gateway contracts for extension lifecycle and MCP connectors.
...
mod tests {
    ...
    fn connector_accepts_secret_reference_and_rejects_url_credentials() {
        ...
        let invalid = serde_json::from_value::<McpConnectorManifestV1>(serde_json::json!({
            "schema_version": 1,
            "id": "aurb.gbrain",
    ...
    #[test]
    fn stdio_command_stays_below_payload() {
