...
use cognit::config::{CacheReportingMode, ProviderTimeoutConfig};
...
impl LlmProvider for OpenAiProvider {
    ...
    async fn complete_stream(
        ...
        let stream = futures::stream::unfold(
            (
                Box::pin(byte_stream),
                crate::utf8_stream::Utf8StreamBuffer::default(),
...
mod tests {
    ...
    mod usage_fixtures {
        ...
        const DEEPSEEK_EXPLICIT_ZERO_HIT: &str =
            include_str!("../../../../cognit/tests/fixtures/usage/deepseek_explicit_zero_hit.json");
        ...
        const NEITHER: &str = include_str!("../../../../cognit/tests/fixtures/usage/neither.json");
