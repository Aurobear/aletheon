...
use crate::application::turn_runtime_ports::ActiveAgentProfilePort;
...
pub(crate) type TestTurnRunner = Arc<
    dyn Fn(
            ...
            'static,
            anyhow::Result<crate::application::turn_coordinator::TurnExecution>,
        > + Send
        + Sync,
>;
...
pub(crate) struct DaemonTurnResources {
    ...
    pub(crate) session_service: Arc<crate::application::session_service::SessionService>,
...
impl DaemonTurnOrchestrator {
    pub(crate) fn new(resources: DaemonTurnResources) -> Self {
        let turn_engine = Arc::new(
            crate::application::daemon_turn_engine::DaemonTurnEngine::new(
