...
#[deprecated(note = "use executive::ExecSessionBuilder")]
pub mod exec_session {
    pub use crate::composition::exec_session::*;
}
...
#[deprecated(note = "legacy session protocol is host compatibility only")]
