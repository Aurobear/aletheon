...
pub struct AgentControlService {
    ...
    event_projections: Arc<dyn crate::application::event_projection::EventProjectionSink>,
...
impl AgentControlService {
    pub fn new(
        ...
        Self {
            ...
            event_spine,
            event_projections: Arc::new(
                crate::application::event_projection::NoopEventProjectionSink,
            ),
