...
use fabric::types::embodiment::{SkillRequest, SkillResult};
...
impl SqliteEpisodeSink {
    ...
    pub fn expire_local_artifact(
        &self,
        artifacts: &crate::adapters::artifact::ArtifactStore,
        episode_id: &str,
        artifact_id: &str,
        expired_at_unix_ms: i64,
        reason: &str,
    ) -> Result<Option<crate::adapters::artifact::ArtifactTombstone>, String> {
...
mod tests {
    use super::*;
    use crate::adapters::artifact::{ArtifactMetadata, ArtifactScanStatus, ArtifactStore};
    use fabric::types::embodiment::{DeviceId, SkillId, SkillOutcome};
    use fabric::types::episode_report::{build_report, ArtifactAvailability, EpisodeReportInput};
    use fabric::types::expected_outcome::OutcomePredicate;
    use fabric::types::outcome_verification::VerificationDecision;
    use fabric::types::skill_proposal::PolicyProvenance;
    use fabric::MonoTime;
    ...
    async fn restart_recovers_each_boundary_and_identical_immutable_report() {
        ...
        let operation =
            fabric::OperationId("00000000-0000-0000-0000-000000000042".parse().unwrap());
