...
use crate::service::agent_control::SqliteAgentRunRepository;
...
pub(super) struct AgentServices {
    ...
    pub agent_live_runs: Arc<crate::service::agent_control::LiveAgentRuns>,
}
...
pub(super) async fn build_agent_services(
    ...
    agent_runtimes: Arc<crate::service::agent_control::AgentRuntimeRegistry>,
    ...
    let agent_control_service = Arc::new(
        ...
        .with_lifecycle_hooks(Arc::new(
            crate::service::agent_control::CorpusAgentLifecycleHookSink(corpus),
        ))
...
pub(super) struct TurnServices {
    ...
    pub turn_orchestrator: Arc<crate::service::DaemonTurnOrchestrator>,
    pub approved_apply: Option<Arc<crate::r#impl::approval::ApplyCoordinator>>,
    pub lifecycle_registry: Arc<crate::service::lifecycle_contributors::LifecycleRegistry>,
}
...
pub(super) async fn build_turn_services(
    ...
    default_session_id: Arc<Mutex<String>>,
    session_id: &str,
    session_created_at: Arc<Mutex<HashMap<String, fabric::MonoTime>>>,
    ...
    runtime_config_snapshot: crate::core::config::ExecutiveConfig,
    core_memory: Arc<Mutex<mnemosyne::CoreMemory>>,
    recall_memory: Arc<Mutex<mnemosyne::RecallMemory>>,
    self_field: Arc<Mutex<dasein::SelfField>>,
    llm: Arc<dyn fabric::LlmProvider>,
    debug_handler: Arc<crate::r#impl::daemon::debug_handler::DebugHandler>,
    ...
    capability_resources: crate::r#impl::daemon::handler::tool_executor::CapabilityResources,
    conscious_registry: Arc<crate::service::conscious_workspace::ConsciousWorkspaceRegistry>,
    ...
    agent_live_runs: Arc<crate::service::agent_control::LiveAgentRuns>,
    ...
    agent_profile_registry: Arc<crate::r#impl::runtime::AgentProfileRegistry>,
    ...
    let session_input = if grok_hardening.prompt_queue {
        let coordinator = crate::service::session_input::SessionInputCoordinator::new(Arc::new(
    ...
    let projection: Arc<dyn crate::service::post_turn_projection::PostTurnProjection> = Arc::new(
