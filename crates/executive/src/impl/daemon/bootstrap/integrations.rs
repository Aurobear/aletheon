...
pub(super) struct GoogleCompositionInput<'a> {
    ...
    pub(super) config: Option<&'a crate::core::config::ResolvedGoogleIntegration>,
}

#[derive(Default)]
pub(super) struct GoogleComposition {
    pub(super) integration: Option<Arc<crate::r#impl::external::GoogleIntegration>>,
    pub(super) sync: Option<crate::r#impl::google::GoogleSyncHandle>,
    pub(super) sync_store: Option<Arc<std::sync::Mutex<crate::r#impl::google::GoogleSyncStore>>>,
    pub(super) gmail_ingress: Option<Arc<crate::r#impl::channel::gmail::GmailGoalEventIngress>>,
