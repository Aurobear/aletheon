...
use crate::service::conscious_core_ports::{CandidateSubmission, CandidateSubmissionReceipt};
...
impl AgentCandidateProjector {
    ...
    fn submission(
        ...
        Ok(CandidateSubmission {
            candidate,
            cause: crate::service::conscious_core_ports::CandidateCause::AgentRuntimeEvent {
