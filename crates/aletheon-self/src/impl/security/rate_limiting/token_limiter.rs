...
impl WindowCounter {
    ...
    fn time_until_slot(&self, now: Instant) -> Option<Duration> {
...
impl TokenRateLimiter {
    pub fn new(max_per_turn: u32, max_per_hour: u32, max_per_day: u32) -> Self {
        Self {
            max_per_turn,
...
mod tests {
    ...
    fn allows_within_per_turn_limit() {
        let mut limiter = TokenRateLimiter::new(100, 10_000, 100_000);
        limiter.begin_turn();
    ...
    fn rejects_when_per_turn_exceeded() {
        let mut limiter = TokenRateLimiter::new(10, 10_000, 100_000);
        limiter.begin_turn();
    ...
    fn delays_when_hourly_limit_approached() {
        ...
        let mut limiter = TokenRateLimiter::new(1000, 5, 100_000);
        limiter.begin_turn();
        for _ in 0..5 {
