            ...
            let entries = stmt
                .query_map(params![limit as i64], |row| {
                    ...
                    let outcome = match outcome_str.as_str() {
                        "partial" => base::ReflectionOutcome::Partial,
                        "failure" => base::ReflectionOutcome::Failure,
                        _ => base::ReflectionOutcome::Success,
                    };
...
mod tests {
    ...
    fn make_reflection(
        ...
        outcome: base::ReflectionOutcome,
        task_summary: &str,
    ) -> ReflectionEntry {
        ReflectionEntry {
    ...
    async fn test_recall_reflections_respects_limit() {
        ...
        for i in 0..5 {
            let entry = make_reflection(
                ...
                base::ReflectionOutcome::Partial,
                &format!("task {}", i),
            );
