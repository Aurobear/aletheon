...
//! `crates/contracts/src/types/extension.rs` or `crates/contracts/src/types/admission.rs`
...
use corpus::ActivationConstraints;
use corpus::ExtensionDescriptor;
use corpus::ExtensionId;
use corpus::ExtensionKind;
use corpus::ExtensionOrigin;
use corpus::ExtensionSnapshot;
