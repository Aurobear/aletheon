...
#[cfg(test)]
use ::contracts::cognitive_workflow::CognitiveArtifact;
...
use crate::cognitive_workspace::{CognitiveWorkspaceCoordinator, CognitiveWorkspaceError};
use stages::*;
use state_machine::{acceptance_plan, coding_plan, RepairBudget, TransitionReason};

pub use state_machine::classify_task_risk;
...
pub struct AgentControlRoleInvoker {
    ...
    wait_timeout_ms: u64,
    delegator_authority: ::contracts::AgentDelegationAuthority,
...
pub struct TurnRoleLaunchContext {
    ...
    pub delegator_authority: ::contracts::AgentDelegationAuthority,
...
pub struct CodingWorkflowReceipt {
    ...
    pub current_owner: ProcessId,
    pub artifact_ids: Vec<::contracts::cognitive_workflow::CognitiveArtifactId>,
...
pub struct AcceptanceWorkflowReceipt {
    pub workspace_version: u64,
    pub current_owner: ProcessId,
    pub validation_artifact_ids: Vec<::contracts::cognitive_workflow::CognitiveArtifactId>,
    pub review_artifact_ids: Vec<::contracts::cognitive_workflow::CognitiveArtifactId>,
    pub repair_artifact_ids: Vec<::contracts::cognitive_workflow::CognitiveArtifactId>,
...
mod tests {
    ...
    impl CognitiveRoleInvoker for AcceptanceInvoker {
        async fn invoke(
            ...
            runtime::agent_admission::CognitiveTaskAdmissionPort::bind_before_launch(
    ...
    async fn fixture(
        ...
        let service: Arc<dyn crate::AgoraService> = Arc::new(crate::AgoraRegistry::new(Arc::new(
    ...
    fn request(owner: ProcessId) -> CodingWorkflowRequest {
        CodingWorkflowRequest {
            ...
            allowed_capabilities: vec![
                ::contracts::AgentRuntimeCapability::CodeRead,
                ::contracts::AgentRuntimeCapability::CodeEdit,
                ::contracts::AgentRuntimeCapability::Test,
            ],
            expected_evidence: vec!["terminal validation receipt".into()],
            risk_level: ::contracts::types::admission::RiskLevel::SystemModify,
        }
    }
    ...
    fn acceptance_request(receipt: &CodingWorkflowReceipt) -> AcceptanceWorkflowRequest {
        AcceptanceWorkflowRequest {
            ...
            workspace_scope: vec!["crates/a".into()],
            project_instructions: vec!["AGENTS.md".into()],
            allowed_capabilities: vec![::contracts::AgentRuntimeCapability::Test],
            expected_evidence: vec!["terminal validation receipt".into()],
            risk_level: ::contracts::types::admission::RiskLevel::SystemModify,
        }
    }
    ...
    async fn low_risk_task_with_no_expected_evidence_skips_planner_and_explorer() {
        ...
        low_risk.risk_level = ::contracts::types::admission::RiskLevel::ReadOnly;
