...
use super::{EmbodiedExecutionPort, RobotExecutionError};
use ::contracts::types::embodiment::{DeviceId, SkillDispatchError, SkillRequest, SkillResult};
use ::contracts::OperationId;
use async_trait::async_trait;

pub struct EmbodiedExecutionAdapter {
    inner: Arc<dyn ::contracts::types::embodiment::EmbodimentExecutionPort>,
    last_operation: Mutex<Option<OperationId>>,
}

impl EmbodiedExecutionAdapter {
    pub fn new(inner: Arc<dyn ::contracts::types::embodiment::EmbodimentExecutionPort>) -> Self {
        Self {
            inner,
...
mod tests {
    use super::*;
    use ::contracts::types::embodiment::{SkillId, SkillOutcome};
    ...
    impl ::contracts::types::embodiment::EmbodimentExecutionPort for FakeFabricPort {
        async fn observe(
            &self,
            _d: &DeviceId,
        ) -> Result<
        ...
        ) -> Result<SkillResult, ::contracts::types::embodiment::SkillDispatchError> {
