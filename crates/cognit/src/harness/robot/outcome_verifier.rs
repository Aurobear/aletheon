...
use super::OutcomeVerifierPort;
use ::contracts::types::embodiment::DeviceId;
use ::contracts::types::expected_outcome::{
...
use ::contracts::{Clock, MonoDeadline};
...
impl OutcomeVerifierPort for DeterministicOutcomeVerifier {
    async fn verify(
        &self,
        expected: &::contracts::types::expected_outcome::ExpectedOutcome,
        device: &DeviceId,
