...
scripts/libexec/aletheon/verify/systemd.sh --core-unit config/aletheon-core.service \
...
grep -q 'config/aletheon-core.service' scripts/libexec/aletheon/install-systemd.sh
